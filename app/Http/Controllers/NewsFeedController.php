...
class NewsFeedController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('media')) {
                ...
                $mediaType = strpos($request->file('media')->getMimeType(), 'image') !== false ? 'image' : 'video';
            }
    ...
    public function comment(Request $request, $newsFeedItemId)
    {
        ...
        return response()->json([
            ...
            'user_image' => $commentWithUser->user->profile_picture ? url('storage/' . $commentWithUser->user->profile_picture) : null,
        ], 200);
    }
